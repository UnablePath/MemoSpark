    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          {data.reminder && (
            <div>
              <Label htmlFor="details-reminder-time" className="text-sm font-medium">
                Remind me
              </Label>
              <Select 
                value={data.reminderMinutes?.toString() || '15'} 
                onValueChange={(value) => onChange({ reminderMinutes: Number(value) })}
              >
