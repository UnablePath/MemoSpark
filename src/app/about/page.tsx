    ...
    <>
      ...
      <main className="pt-16 min-h-screen">
        <div className="container mx-auto px-4 py-8 md:py-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 text-primary">About StudySpark</h1>
          <div className="prose lg:prose-xl dark:prose-invert max-w-none">
            <p>
              Welcome to StudySpark, your ultimate study companion designed to revolutionize the way you learn and manage your academic life.
            </p>
            <p>
              ...
              experience, and StudySpark is built to make that a reality.
            </p>
            <h2 className="text-2xl font-semibold mt-8 mb-4">Our Vision</h2>
            <p>
              We envision a world where every student has the tools and motivation to achieve their full academic potential. 
              StudySpark aims to be at the forefront of educational technology, continuously evolving to meet the dynamic needs of learners.
            </p>
            <h2 className="text-2xl font-semibold mt-8 mb-4">Why StudySpark?</h2>
            <ul>
            ...
            <p className="mt-6">
              StudySpark is more than just an app; it's a partner in your educational journey. We are committed to helping you spark your curiosity, 
              ignite your passion for learning, and achieve academic excellence.
            </p>
            <p className="mt-4">
              Thank you for choosing StudySpark. Let's make learning an adventure!
            </p>
          </div>
        </div>
      </main>
